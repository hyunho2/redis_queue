...
public class RedisRepositoryConfigTest {
    ...
    public void testSortedSet() {
        ...
        stringStringZSetOperations.add(key, "H1", System.currentTimeMillis());
        stringStringZSetOperations.add(key, "L2", System.currentTimeMillis());
        ...
        scoreRange = stringStringZSetOperations.range(key,1, 5);
